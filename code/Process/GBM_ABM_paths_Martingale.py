...
def mainCalculation(NoOfPaths, NoOfSteps, T, r, sigma, S_0):
    ...
    plt.title("Geometric Brownian Motion X(t) (log of stock price) Paths under martingale measure")
    plt.grid()
    plt.xlabel("time")
    plt.ylabel("X(t)")
    ...
    plt.title("Geometric Brownian Motion S(t) (stock price) Paths under martingale measure")
    plt.grid()
    plt.xlabel("time")
    plt.ylabel("S(t)")
